...
import { UserDataRequest } from '../../shared/class-tr/classtr-req-user-data';
...
import { commonClass } from '../../shared/class/class-commondto';
import { User2100Component } from '../user2100/user2100.component';

@Component({
  selector: 'app-user2000',
  templateUrl: './user2000.component.html',
  styleUrls: ['./user2000.component.css']
})
export class User2000Component implements OnInit {
